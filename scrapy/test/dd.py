...
class D:
	cook=''
	def main(self):
		D.cook=self.login_cookie('igupiao.com.cn', 'admin', 'Mnbvcx1!')
		# print(D.cook)
		print('=====================================')
		self.addcontent('igupiao.com.cn', 1, 'dem111311111o12', 'cookie11', cookie=D.cook)
	...
	def addcontent(self,url, classid, title, content, cookie=None):
		...
		head = '''
Accept: text/html, application/xhtml+xml, image/jxr, */*
Referer:http://www.{0}/e/admin/AddNews.php?enews=AddNews&ecmsnfrom=1&bclassid=6&classid={1}
Accept-Language: zh-CN
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko
Content-Type: multipart/form-data; boundary=---------------------------7e1f9223021e
Accept-Encoding: gzip, deflate
...
if __name__=='__main__':
	...
	# print(s.headers)
	# a=D()
	c=login_cookie('igupiao.com.cn', 'admin', 'Mnbvcx1!')
	addcontent('igupiao.com.cn', 2, 'demo12', 'cookie11', cookie=c)
	# a=D()
	# a.main()
	# print(a.cook)
